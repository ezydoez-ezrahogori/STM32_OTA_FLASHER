...
static void eeprom_read_entry (char * target, int offset, int len)
{
    int   i;
...
static uint8_t eeprom_read_byte (int offset)
{
    uint8_t   value;
...
static void eeprom_write_entry (char * src, int offset, int len)
{
    int   i;
...
static void eeprom_write_byte (uint8_t src, int offset)
{
 ...
 *----------------------------------------------------------------------------------------------------------------------------------------
 */
static void eeprom_save_magic (void)
{
 ...
 *----------------------------------------------------------------------------------------------------------------------------------------
 */
static void eeprom_save_version (void)
{
 ...
 *----------------------------------------------------------------------------------------------------------------------------------------
 */
void eeprom_save_ap_ssidkey (void)
{
