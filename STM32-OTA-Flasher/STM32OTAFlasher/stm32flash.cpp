 ...
 *-------------------------------------------------------------------------------------------------------------------------------------------
 */
int stm32_serial_poll (unsigned long timeout, int log_error)
{
 ...
 *-------------------------------------------------------------------------------------------------------------------------------------------
 */
static int wait_for_ack (long timeout, int show_errors)
{
    int ch;
 ...
 *-------------------------------------------------------------------------------------------------------------------------------------------
 */
static void stm32_write_cmd (uint8_t cmd)
{
 ...
 *-------------------------------------------------------------------------------------------------------------------------------------------
 */
static int stm32_get (uint8_t * buf, int maxlen)
{
    int i;
    int ch;
    int n_bytes;
 ...
 */
#if 0 // yet not used
static int stm32_get_version (uint8_t * buf, int maxlen)
{
    int i;
    int ch;
    int n_bytes;
 ...
 */
#if 0 // yet not used
static int stm32_get_id (uint8_t * buf, int maxlen)
{
    int i;
    int ch;
    int n_bytes;
 ...
 *-------------------------------------------------------------------------------------------------------------------------------------------
 */
static int stm32_read_memory (uint32_t address, unsigned int len)
{
    unsigned int  i;
    int           ch;
 ...
 */
#if 0 // yet not used
static int stm32_go (uint32_t address)
{
 ...
 *-------------------------------------------------------------------------------------------------------------------------------------------
 */
static int stm32_write_memory (uint8_t * image, uint32_t address, unsigned int len)
{
    uint8_t       sum;
    unsigned int  i;
 ...
 *-------------------------------------------------------------------------------------------------------------------------------------------
 */
static int stm32_write_unprotect (void)
{
 ...
 *-------------------------------------------------------------------------------------------------------------------------------------------
 */
static int stm32_erase (uint8_t * pagenumbers, uint16_t n_pages)
{
    int     i;
    uint8_t real_pages;
    uint8_t sum;
 ...
 *-------------------------------------------------------------------------------------------------------------------------------------------
 */
static int stm32_ext_erase (uint16_t * pagenumbers, uint16_t n_pages)
{
    int         i;
    uint16_t    real_pages;
    uint8_t     sum;
...
static int stm32_flash_image (String fname, bool do_flash)
{
 ...
 *-------------------------------------------------------------------------------------------------------------------------------------------
 */
void stm32_check_hex_file (String fname)
{
 ...
 *-------------------------------------------------------------------------------------------------------------------------------------------
 */
void stm32_flash_from_local (String fname)
{
